...
class Player{
  constructor(name, house, funFact, talent, major, year){
    this.name = name
    this.house = house
  ...
  getString() {
    return '<b>'+this.name + '</b><br>'+YEAR[this.year]+'<br>'+this.major+'<br><b>Harry Potter House<br></b>'+HARRY_HOUSES[this.house]+'<br><b>Fun Fact</b><br>'+this.funFact+'<br><b>Secret Talent</b><br>'+this.talent;
  }
  getImage() {
...
new Player("Cora Wessman", 0, "I stole a piece of George Washington’s House once","Art of sorts","Environmental Science",4),
...
new Player("Amy Copper", 0, "My twin sister fell down the stairs as a baby, and then I just followed her all the way down :^)","I can do that clover thing with my tongue ","Double in History and Anthropology",3),
...
new DummyPlayer("Angelo Ramos", "", 5)
];
